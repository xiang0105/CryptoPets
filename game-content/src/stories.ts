...
export const expeditionForests: ExpeditionForest[] = [
  {
    ...
    difficulty: 1,
    durationSeconds: 45,
    reward: '柚子果 / Yuzu Bite',
    name: { zh: '橘子森林', en: 'Orange Forest' },
    summary: { zh: '入門柑橘路線，完成遠征會帶回柚子果。', en: 'A starter citrus route that brings back Yuzu Bite when completed.' },
  ...
  },
  {
    ...
    difficulty: 2,
    durationSeconds: 90,
    reward: '柿子果醬 / Persimmon Jam',
    name: { zh: '蘋果森林', en: 'Apple Forest' },
    summary: { zh: '耐力要求更高的果園路線，完成遠征會帶回柿子果醬。', en: 'A tougher orchard route that brings back Persimmon Jam when completed.' },
  ...
  },
  {
    ...
    difficulty: 3,
    durationSeconds: 150,
    reward: '冰晶 / Ice Crystal',
    name: { zh: '水蜜桃雪森', en: 'Snow Peach Forest' },
    summary: { zh: '寒氣最重的高難度路線，完成遠征會帶回冰晶。', en: 'The coldest high-difficulty route that brings back Ice Crystals when completed.' },
